...
namespace ApplicationDiscord.Migrations
{
    ...
    [Migration("20250218124353_ChangeRelationshipBetweenUserAndRelationships")]
    partial class ChangeRelationshipBetweenUserAndRelationships
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RelationshipUser", b =>
                {
                    ...
                    b.HasKey("RelationshipsId", "UsersId");
            ...
            modelBuilder.Entity("RelationshipUser", b =>
                {
                    b.HasOne("DiscordDomain.Models.Relationship", null)
                        .WithMany()
                        .HasForeignKey("RelationshipsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DiscordDomain.Models.User", null)
                        .WithMany()
