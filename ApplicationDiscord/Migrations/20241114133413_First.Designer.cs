...
namespace ApplicationDiscord.Migrations
{
    ...
    [Migration("20241114133413_First")]
    partial class First
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DiscordDomain.Models.User", b =>
                {
                    ...
                    b.Property<Guid?>("AuthorizationTokenId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("AuthorizationTokenId")
                        .IsUnique();
            ...
            modelBuilder.Entity("DiscordDomain.Models.User", b =>
                {
                    b.HasOne("DiscordDomain.Models.AuthorizationToken", "AuthorizationToken")
                        .WithOne("User")
                        .HasForeignKey("DiscordDomain.Models.User", "AuthorizationTokenId")
                        .OnDelete(DeleteBehavior.Restrict);
